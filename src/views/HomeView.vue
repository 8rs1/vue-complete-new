<template>
  <main class="xl:flex gap-x-28 container">
    ...
    <div class="py-8 xl:col-span-2">
      ...
      <h1 class="text-4xl xl:text-6xl font-semibold my-4">Fall Limited Edition Sneakers</h1>
      <p class="mt-10 text-slate-700">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo quasi
        culpa dolor, ullam repellat, voluptate perferendis nisi molestias
        delectus ipsam maiores et, fugiat aspernatur voluptatem numquam eos
        neque quis harum!
      </p>
